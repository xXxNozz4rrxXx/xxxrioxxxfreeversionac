...
AntiCheat.FakeEvents =  {
    ...
    'AntiLynxR4:log',
    'rio_communityservice:sendToCommunityService',
    'rio-qalle-needs:add',
    'esx-qalle-needs:add',
    'bank:deposit',
    'bank:withdraw',
...
AntiCheat.RegisterFakeEvents = function()
    Citizen.CreateThread(function()
        ...
        print("^4===========[W E L C O M E]============= ")
        SetConvarServerInfo("💲 Best AntiCheat", "🧧 By Nuclear Team")
        print("^3[RioWare] ^0Authenticating to RioWare.....")
        Wait(10000)
        print("^3[RioWare] ^2Authentification was successful. Enjoy your anti-cheat !")
        Wait(10000)
        print("^3[RioWare] ^0Checking RioWare's files...")
        Wait(10000)
        print("^3[RioWare] ^2RioWare's files are corrects !")
        Wait(10000)
        print("^3[RioWare] ^0Checking RioWare's Version...")
        Wait(10000)
        print("^3[RioWare] ^2RioWare's Version is ok !")
        Wait(10000)
        print("^3[RioWare] ^0Checking your configs files...")
        Wait(10000)
        print("^1Getting RioClient Version: 4.0.0.a ")
        Wait(10000)
        print("^3Intializing FakeEvents:--...........[SUCCESS] ")
        Wait(30000)
        print("^2EventInfo:[Stable] ")
        print("^1Anticheat Status : [Running]")
        print("^3Server Protection: [ON]")
        print("^2Checking Anticheat Addons : [Status : Online]")
        Wait(10000)
        print("^1Intializing Prefix:--...........[SUCCESS] ")
        Wait(10000)
        print("^31Intializing BlaclistedWeapons:---...........[SUCCESS] ")
        Wait(10000)
        print("^2Intializing BlaclistedAddons:---...........[SUCCESS] ")
        Wait(10000)
        print("^2Intializing BlaclistedModels:--...........[SUCCESS] ")
        Wait(10000)
        print("^2Intializing BlaclistedProps:---...........[SUCCESS] ")
        Wait(10000)
        print("^3[RioWare] ^7 ^AntiCheat.Language ^7: ^1Recommended to be  [ACTIVE]^7!")
        Wait(10000)
        print("^3[RioWare] ^7 ^AntiCheat.GlobalBanSystem ^7: ^1Recommended to be  [ACTIVE] ^7!")
        Wait(10000)
        print("^3[RioWare] ^7 ^AntiCheat.DiscordWebhook ^7: ^1Recommended to be  [ACTIVE]^7!")
        Wait(10000)
        print("^3[RioWare] ^7 ^AntiCheat.RunningOS ^7: ^1Recommended to be  [ACTIVE] ^7!")
        Wait(10000)
        print("^3[RioWare] ^7 ^AntiCheat.BypassAce ^7: ^1Recommended to be  [ACTIVE] ^7!")
        Wait(10000)
        print("^3[RioWare] ^7 ^AntiCheat.EnableCountryWhitelist ^7: ^1Recommended to be  [ACTIVE] ^7!")
        Wait(10000)
        print("^3[RioWare] ^7 ^AntiCheat.EnableCountryWhitelist ^7: ^1Recommended to be  [ACTIVE] ^7!")
        Wait(10000)
        print("^1Anticheat Crated ^3by Rio")
        print("^1NuclearTeam^3 @2021 All Copy rights Reversed^7")
        print("^1Credits to:^3 @jOHND for the Server and Client Events (Patched)^7")
        print("^4===========[R I O CLIENT]============= ")
        Wait(45000)
        print(AntiCheat.Render("[{{{resource}}}][INFO]^7 {{{count}}} Registered fake events! ^2Rio-AntiCheat works great ^7", {
            resource = GetCurrentResourceName(),
            count = count
        }))
        print(AntiCheat.Render("[{{{resource}}}][INFO]^7 Developer:Rio ^3for any problems please contact with Rio", {
            resource = GetCurrentResourceName(),
        }))
        print("^1RioWare/Anticheat:^3 SuccessFully Started on Your Server^7[INFO]:Version: 4.0.0 | RioServices are Updated!")
    end)
end
